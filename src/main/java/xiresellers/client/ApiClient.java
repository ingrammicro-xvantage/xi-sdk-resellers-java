...
import xiresellers.client.auth.Authentication;
import xiresellers.client.auth.HttpBasicAuth;
import xiresellers.client.auth.HttpBearerAuth;
import xiresellers.client.auth.ApiKeyAuth;
import xiresellers.client.auth.OAuth;
import xiresellers.client.auth.RetryingOAuth;
import xiresellers.client.auth.OAuthFlow;
...
public class ApiClient {
    ...
    protected String basePath = "https://api.ingrammicro.com:443";
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://api.ingrammicro.com:443/oauth/oauth30/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.ingrammicro.com:443)
     ...
     * @return a {@link xiresellers.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws xiresellers.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws xiresellers.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws xiresellers.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws xiresellers.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws xiresellers.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws xiresellers.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws xiresellers.client.ApiException If fails to update the parameters
     */
     ...
     * @throws xiresellers.client.ApiException If fail to serialize the request body object into a string
     */
