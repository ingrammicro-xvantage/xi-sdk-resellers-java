...
public class ReturnsSearchResponse {
  ...
  @javax.annotation.Nullable
  private List<ReturnsSearchResponseReturnsClaimsInner> returnsClaims = new ArrayList<>();
  ...
  public ReturnsSearchResponse recordsFound(@javax.annotation.Nullable Integer recordsFound) {
  ...
  public ReturnsSearchResponse pageSize(@javax.annotation.Nullable Integer pageSize) {
  ...
  public ReturnsSearchResponse pageNumber(@javax.annotation.Nullable Integer pageNumber) {
  ...
  public ReturnsSearchResponse returnsClaims(@javax.annotation.Nullable List<ReturnsSearchResponseReturnsClaimsInner> returnsClaims) {
  ...
  public void setReturnsClaims(@javax.annotation.Nullable List<ReturnsSearchResponseReturnsClaimsInner> returnsClaims) {
    this.returnsClaims = returnsClaims;
  }


  public ReturnsSearchResponse nextPage(@javax.annotation.Nullable String nextPage) {
  ...
  public ReturnsSearchResponse previousPage(@javax.annotation.Nullable String previousPage) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("recordsFound", "pageSize", "pageNumber", "returnsClaims", "nextPage", "previousPage"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReturnsSearchResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReturnsSearchResponse is not found in the empty JSON string", ReturnsSearchResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReturnsSearchResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ReturnsSearchResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("nextPage") != null && !jsonObj.get("nextPage").isJsonNull()) && !jsonObj.get("nextPage").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `nextPage` to be a primitive type in the JSON string but got `%s`", jsonObj.get("nextPage").toString()));
      }
      if ((jsonObj.get("previousPage") != null && !jsonObj.get("previousPage").isJsonNull()) && !jsonObj.get("previousPage").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `previousPage` to be a primitive type in the JSON string but got `%s`", jsonObj.get("previousPage").toString()));
      }
  }
