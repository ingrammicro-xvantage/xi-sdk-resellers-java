  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner is not found in the empty JSON string", PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PriceAndAvailabilityResponseInnerDiscountsInnerSpecialPricingInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("specialBidNumer") != null && !jsonObj.get("specialBidNumer").isJsonNull()) && !jsonObj.get("specialBidNumer").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `specialBidNumer` to be a primitive type in the JSON string but got `%s`", jsonObj.get("specialBidNumer").toString()));
      }
      if ((jsonObj.get("governmentDiscountType") != null && !jsonObj.get("governmentDiscountType").isJsonNull()) && !jsonObj.get("governmentDiscountType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `governmentDiscountType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("governmentDiscountType").toString()));
      }
  }
