...
public class OrderModifyRequestShipToInfo {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("addressId", "contact", "companyName", "name1", "name2", "addressLine1", "addressLine2", "addressLine3", "city", "state", "postalCode", "countryCode", "phoneNumber", "email"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderModifyRequestShipToInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in OrderModifyRequestShipToInfo is not found in the empty JSON string", OrderModifyRequestShipToInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderModifyRequestShipToInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OrderModifyRequestShipToInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
