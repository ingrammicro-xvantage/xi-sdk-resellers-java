  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PriceAndAvailabilityRequestAvailabilityByWarehouseInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PriceAndAvailabilityRequestAvailabilityByWarehouseInner is not found in the empty JSON string", PriceAndAvailabilityRequestAvailabilityByWarehouseInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PriceAndAvailabilityRequestAvailabilityByWarehouseInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PriceAndAvailabilityRequestAvailabilityByWarehouseInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("availabilityByWarehouseId") != null && !jsonObj.get("availabilityByWarehouseId").isJsonNull()) && !jsonObj.get("availabilityByWarehouseId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `availabilityByWarehouseId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("availabilityByWarehouseId").toString()));
      }
  }
