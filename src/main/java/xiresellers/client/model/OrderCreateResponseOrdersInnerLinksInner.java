...
public class OrderCreateResponseOrdersInnerLinksInner {
  ...
  public OrderCreateResponseOrdersInnerLinksInner topic(@javax.annotation.Nullable String topic) {
    this.topic = topic;
    return this;
  }
  ...
  public OrderCreateResponseOrdersInnerLinksInner href(@javax.annotation.Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public OrderCreateResponseOrdersInnerLinksInner type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderCreateResponseOrdersInnerLinksInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OrderCreateResponseOrdersInnerLinksInner is not found in the empty JSON string", OrderCreateResponseOrdersInnerLinksInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderCreateResponseOrdersInnerLinksInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OrderCreateResponseOrdersInnerLinksInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
