  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderDetailB2BLinesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OrderDetailB2BLinesInner is not found in the empty JSON string", OrderDetailB2BLinesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderDetailB2BLinesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OrderDetailB2BLinesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("subOrderNumber") != null && !jsonObj.get("subOrderNumber").isJsonNull()) && !jsonObj.get("subOrderNumber").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `subOrderNumber` to be a primitive type in the JSON string but got `%s`", jsonObj.get("subOrderNumber").toString()));
      }
      if ((jsonObj.get("ingramOrderLineNumber") != null && !jsonObj.get("ingramOrderLineNumber").isJsonNull()) && !jsonObj.get("ingramOrderLineNumber").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `ingramOrderLineNumber` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ingramOrderLineNumber").toString()));
      }
      if ((jsonObj.get("vendorSalesOrderLineNumber") != null && !jsonObj.get("vendorSalesOrderLineNumber").isJsonNull()) && !jsonObj.get("vendorSalesOrderLineNumber").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `vendorSalesOrderLineNumber` to be a primitive type in the JSON string but got `%s`", jsonObj.get("vendorSalesOrderLineNumber").toString()));
      }
      ...
      if ((jsonObj.get("lineStatus") != null && !jsonObj.get("lineStatus").isJsonNull()) && !jsonObj.get("lineStatus").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `lineStatus` to be a primitive type in the JSON string but got `%s`", jsonObj.get("lineStatus").toString()));
      }
      ...
      if ((jsonObj.get("partDescription") != null && !jsonObj.get("partDescription").isJsonNull()) && !jsonObj.get("partDescription").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `partDescription` to be a primitive type in the JSON string but got `%s`", jsonObj.get("partDescription").toString()));
      }
      if ((jsonObj.get("weightUom") != null && !jsonObj.get("weightUom").isJsonNull()) && !jsonObj.get("weightUom").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `weightUom` to be a primitive type in the JSON string but got `%s`", jsonObj.get("weightUom").toString()));
      }
      ...
      if ((jsonObj.get("requestedDeliverydate") != null && !jsonObj.get("requestedDeliverydate").isJsonNull()) && !jsonObj.get("requestedDeliverydate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `requestedDeliverydate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("requestedDeliverydate").toString()));
      }
      if ((jsonObj.get("promisedDeliveryDate") != null && !jsonObj.get("promisedDeliveryDate").isJsonNull()) && !jsonObj.get("promisedDeliveryDate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `promisedDeliveryDate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("promisedDeliveryDate").toString()));
      }
      if ((jsonObj.get("backOrderETADate") != null && !jsonObj.get("backOrderETADate").isJsonNull()) && !jsonObj.get("backOrderETADate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `backOrderETADate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("backOrderETADate").toString()));
      }
      if ((jsonObj.get("lineNotes") != null && !jsonObj.get("lineNotes").isJsonNull()) && !jsonObj.get("lineNotes").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `lineNotes` to be a primitive type in the JSON string but got `%s`", jsonObj.get("lineNotes").toString()));
      }
      if (jsonObj.get("shipmentDetails") != null && !jsonObj.get("shipmentDetails").isJsonNull()) {
        ...
        if (jsonArrayshipmentDetails != null) {
          ...
          if (!jsonObj.get("shipmentDetails").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `shipmentDetails` to be an array in the JSON string but got `%s`", jsonObj.get("shipmentDetails").toString()));
          }
      ...
      if (jsonObj.get("estimatedDates") != null && !jsonObj.get("estimatedDates").isJsonNull()) {
        ...
        if (jsonArrayestimatedDates != null) {
          ...
          if (!jsonObj.get("estimatedDates").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `estimatedDates` to be an array in the JSON string but got `%s`", jsonObj.get("estimatedDates").toString()));
          }
      ...
      if (jsonObj.get("scheduleLines") != null && !jsonObj.get("scheduleLines").isJsonNull()) {
        ...
        if (jsonArrayscheduleLines != null) {
          ...
          if (!jsonObj.get("scheduleLines").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `scheduleLines` to be an array in the JSON string but got `%s`", jsonObj.get("scheduleLines").toString()));
          }
      ...
      if (jsonObj.get("multipleShipments") != null && !jsonObj.get("multipleShipments").isJsonNull()) {
        ...
        if (jsonArraymultipleShipments != null) {
          ...
          if (!jsonObj.get("multipleShipments").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `multipleShipments` to be an array in the JSON string but got `%s`", jsonObj.get("multipleShipments").toString()));
          }
      ...
      if ((jsonObj.get("defaultCarrierName") != null && !jsonObj.get("defaultCarrierName").isJsonNull()) && !jsonObj.get("defaultCarrierName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `defaultCarrierName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("defaultCarrierName").toString()));
      }
  }
