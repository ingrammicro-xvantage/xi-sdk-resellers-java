  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostCreateorderV7400ResponseFieldsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PostCreateorderV7400ResponseFieldsInner is not found in the empty JSON string", PostCreateorderV7400ResponseFieldsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostCreateorderV7400ResponseFieldsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PostCreateorderV7400ResponseFieldsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
