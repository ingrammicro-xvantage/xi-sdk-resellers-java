...
public class PostCreateorderV7400ResponseFieldsInner {
  ...
  public PostCreateorderV7400ResponseFieldsInner field(@javax.annotation.Nullable String field) {
    this.field = field;
    return this;
  }
  ...
  public PostCreateorderV7400ResponseFieldsInner message(@javax.annotation.Nullable String message) {
  ...
  public PostCreateorderV7400ResponseFieldsInner value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostCreateorderV7400ResponseFieldsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PostCreateorderV7400ResponseFieldsInner is not found in the empty JSON string", PostCreateorderV7400ResponseFieldsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostCreateorderV7400ResponseFieldsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PostCreateorderV7400ResponseFieldsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
