  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProductDetailResponseAdditionalInformation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProductDetailResponseAdditionalInformation is not found in the empty JSON string", ProductDetailResponseAdditionalInformation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProductDetailResponseAdditionalInformation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ProductDetailResponseAdditionalInformation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("productWeight") != null && !jsonObj.get("productWeight").isJsonNull()) {
        ...
        if (jsonArrayproductWeight != null) {
          ...
          if (!jsonObj.get("productWeight").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `productWeight` to be an array in the JSON string but got `%s`", jsonObj.get("productWeight").toString()));
          }
      ...
      if ((jsonObj.get("netWeight") != null && !jsonObj.get("netWeight").isJsonNull()) && !jsonObj.get("netWeight").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `netWeight` to be a primitive type in the JSON string but got `%s`", jsonObj.get("netWeight").toString()));
      }
      if ((jsonObj.get("dimensionUnit") != null && !jsonObj.get("dimensionUnit").isJsonNull()) && !jsonObj.get("dimensionUnit").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `dimensionUnit` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dimensionUnit").toString()));
      }
  }
