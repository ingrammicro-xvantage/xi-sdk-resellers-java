...
public class GetAccesstoken400Response {
  ...
  public boolean equals(Object o) {
    ...
    GetAccesstoken400Response getAccesstoken400Response = (GetAccesstoken400Response) o;
    return Objects.equals(this.message, getAccesstoken400Response.message);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAccesstoken400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetAccesstoken400Response is not found in the empty JSON string", GetAccesstoken400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAccesstoken400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetAccesstoken400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetAccesstoken400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetAccesstoken400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetAccesstoken400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAccesstoken400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAccesstoken400Response>() {
           @Override
           public void write(JsonWriter out, GetAccesstoken400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetAccesstoken400Response read(JsonReader in) throws IOException {
