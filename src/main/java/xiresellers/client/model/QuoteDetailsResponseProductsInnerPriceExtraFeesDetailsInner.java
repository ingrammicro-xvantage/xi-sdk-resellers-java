  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QuoteDetailsResponseProductsInnerPriceExtraFeesDetailsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in QuoteDetailsResponseProductsInnerPriceExtraFeesDetailsInner is not found in the empty JSON string", QuoteDetailsResponseProductsInnerPriceExtraFeesDetailsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!QuoteDetailsResponseProductsInnerPriceExtraFeesDetailsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `QuoteDetailsResponseProductsInnerPriceExtraFeesDetailsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("extraFeesDescription") != null && !jsonObj.get("extraFeesDescription").isJsonNull()) && !jsonObj.get("extraFeesDescription").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `extraFeesDescription` to be a primitive type in the JSON string but got `%s`", jsonObj.get("extraFeesDescription").toString()));
      }
  }
