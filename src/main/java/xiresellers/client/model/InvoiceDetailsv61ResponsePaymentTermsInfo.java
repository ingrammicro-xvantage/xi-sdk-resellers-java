  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InvoiceDetailsv61ResponsePaymentTermsInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in InvoiceDetailsv61ResponsePaymentTermsInfo is not found in the empty JSON string", InvoiceDetailsv61ResponsePaymentTermsInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InvoiceDetailsv61ResponsePaymentTermsInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `InvoiceDetailsv61ResponsePaymentTermsInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("paymentTermsCode") != null && !jsonObj.get("paymentTermsCode").isJsonNull()) && !jsonObj.get("paymentTermsCode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `paymentTermsCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("paymentTermsCode").toString()));
      }
      if ((jsonObj.get("paymentTermsDescription") != null && !jsonObj.get("paymentTermsDescription").isJsonNull()) && !jsonObj.get("paymentTermsDescription").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `paymentTermsDescription` to be a primitive type in the JSON string but got `%s`", jsonObj.get("paymentTermsDescription").toString()));
      }
