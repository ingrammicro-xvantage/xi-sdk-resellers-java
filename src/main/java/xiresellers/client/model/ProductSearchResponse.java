  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProductSearchResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ProductSearchResponse is not found in the empty JSON string", ProductSearchResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProductSearchResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ProductSearchResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("catalog") != null && !jsonObj.get("catalog").isJsonNull()) {
        ...
        if (jsonArraycatalog != null) {
          ...
          if (!jsonObj.get("catalog").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `catalog` to be an array in the JSON string but got `%s`", jsonObj.get("catalog").toString()));
          }
      ...
      if (jsonObj.get("subscriptionCatalog") != null && !jsonObj.get("subscriptionCatalog").isJsonNull()) {
        ...
        if (jsonArraysubscriptionCatalog != null) {
          ...
          if (!jsonObj.get("subscriptionCatalog").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `subscriptionCatalog` to be an array in the JSON string but got `%s`", jsonObj.get("subscriptionCatalog").toString()));
          }
