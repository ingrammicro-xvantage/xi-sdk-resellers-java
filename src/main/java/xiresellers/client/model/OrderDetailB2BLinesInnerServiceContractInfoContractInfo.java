  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderDetailB2BLinesInnerServiceContractInfoContractInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OrderDetailB2BLinesInnerServiceContractInfoContractInfo is not found in the empty JSON string", OrderDetailB2BLinesInnerServiceContractInfoContractInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderDetailB2BLinesInnerServiceContractInfoContractInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OrderDetailB2BLinesInnerServiceContractInfoContractInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("contractDescription") != null && !jsonObj.get("contractDescription").isJsonNull()) && !jsonObj.get("contractDescription").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `contractDescription` to be a primitive type in the JSON string but got `%s`", jsonObj.get("contractDescription").toString()));
      }
      if ((jsonObj.get("contractNumber") != null && !jsonObj.get("contractNumber").isJsonNull()) && !jsonObj.get("contractNumber").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `contractNumber` to be a primitive type in the JSON string but got `%s`", jsonObj.get("contractNumber").toString()));
      }
      if ((jsonObj.get("contractStatus") != null && !jsonObj.get("contractStatus").isJsonNull()) && !jsonObj.get("contractStatus").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `contractStatus` to be a primitive type in the JSON string but got `%s`", jsonObj.get("contractStatus").toString()));
      }
      if ((jsonObj.get("contractStartDate") != null && !jsonObj.get("contractStartDate").isJsonNull()) && !jsonObj.get("contractStartDate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `contractStartDate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("contractStartDate").toString()));
      }
      if ((jsonObj.get("contractEndDate") != null && !jsonObj.get("contractEndDate").isJsonNull()) && !jsonObj.get("contractEndDate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `contractEndDate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("contractEndDate").toString()));
      }
      if ((jsonObj.get("contractDuration") != null && !jsonObj.get("contractDuration").isJsonNull()) && !jsonObj.get("contractDuration").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `contractDuration` to be a primitive type in the JSON string but got `%s`", jsonObj.get("contractDuration").toString()));
      }
  }
