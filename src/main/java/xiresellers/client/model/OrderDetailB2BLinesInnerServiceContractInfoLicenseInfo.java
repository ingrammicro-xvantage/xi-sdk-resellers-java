  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderDetailB2BLinesInnerServiceContractInfoLicenseInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OrderDetailB2BLinesInnerServiceContractInfoLicenseInfo is not found in the empty JSON string", OrderDetailB2BLinesInnerServiceContractInfoLicenseInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderDetailB2BLinesInnerServiceContractInfoLicenseInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OrderDetailB2BLinesInnerServiceContractInfoLicenseInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("licenseNumber") != null && !jsonObj.get("licenseNumber").isJsonNull() && !jsonObj.get("licenseNumber").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `licenseNumber` to be an array in the JSON string but got `%s`", jsonObj.get("licenseNumber").toString()));
      }
      if ((jsonObj.get("licenseStartDate") != null && !jsonObj.get("licenseStartDate").isJsonNull()) && !jsonObj.get("licenseStartDate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `licenseStartDate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("licenseStartDate").toString()));
      }
      if ((jsonObj.get("licenseEndDate") != null && !jsonObj.get("licenseEndDate").isJsonNull()) && !jsonObj.get("licenseEndDate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `licenseEndDate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("licenseEndDate").toString()));
      }
