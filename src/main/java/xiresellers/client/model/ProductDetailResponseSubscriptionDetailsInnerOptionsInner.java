  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProductDetailResponseSubscriptionDetailsInnerOptionsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ProductDetailResponseSubscriptionDetailsInnerOptionsInner is not found in the empty JSON string", ProductDetailResponseSubscriptionDetailsInnerOptionsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProductDetailResponseSubscriptionDetailsInnerOptionsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ProductDetailResponseSubscriptionDetailsInnerOptionsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("minUnits") != null && !jsonObj.get("minUnits").isJsonNull()) && !jsonObj.get("minUnits").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `minUnits` to be a primitive type in the JSON string but got `%s`", jsonObj.get("minUnits").toString()));
      }
      if ((jsonObj.get("maxUnits") != null && !jsonObj.get("maxUnits").isJsonNull()) && !jsonObj.get("maxUnits").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `maxUnits` to be a primitive type in the JSON string but got `%s`", jsonObj.get("maxUnits").toString()));
      }
      if ((jsonObj.get("dependsOn") != null && !jsonObj.get("dependsOn").isJsonNull()) && !jsonObj.get("dependsOn").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `dependsOn` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dependsOn").toString()));
      }
  }
