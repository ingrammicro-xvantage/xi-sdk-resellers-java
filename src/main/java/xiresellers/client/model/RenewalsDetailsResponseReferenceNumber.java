...
public class RenewalsDetailsResponseReferenceNumber {
  ...
  public boolean equals(Object o) {
    ...
    RenewalsDetailsResponseReferenceNumber renewalsDetailsResponseReferenceNumber = (RenewalsDetailsResponseReferenceNumber) o;
    return Objects.equals(this.notificationId, renewalsDetailsResponseReferenceNumber.notificationId) &&
        Objects.equals(this.quoteNumber, renewalsDetailsResponseReferenceNumber.quoteNumber);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("notificationId", "quoteNumber"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RenewalsDetailsResponseReferenceNumber.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RenewalsDetailsResponseReferenceNumber is not found in the empty JSON string", RenewalsDetailsResponseReferenceNumber.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RenewalsDetailsResponseReferenceNumber.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RenewalsDetailsResponseReferenceNumber` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("notificationId") != null && !jsonObj.get("notificationId").isJsonNull()) && !jsonObj.get("notificationId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `notificationId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("notificationId").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RenewalsDetailsResponseReferenceNumber.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RenewalsDetailsResponseReferenceNumber' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RenewalsDetailsResponseReferenceNumber> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RenewalsDetailsResponseReferenceNumber.class));

       return (TypeAdapter<T>) new TypeAdapter<RenewalsDetailsResponseReferenceNumber>() {
           @Override
           public void write(JsonWriter out, RenewalsDetailsResponseReferenceNumber value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RenewalsDetailsResponseReferenceNumber read(JsonReader in) throws IOException {
