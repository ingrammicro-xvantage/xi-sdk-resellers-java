  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProductSearchResponseSubscriptionCatalogInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProductSearchResponseSubscriptionCatalogInner is not found in the empty JSON string", ProductSearchResponseSubscriptionCatalogInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProductSearchResponseSubscriptionCatalogInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ProductSearchResponseSubscriptionCatalogInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("numberOfPlans") != null && !jsonObj.get("numberOfPlans").isJsonNull()) && !jsonObj.get("numberOfPlans").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `numberOfPlans` to be a primitive type in the JSON string but got `%s`", jsonObj.get("numberOfPlans").toString()));
      }
