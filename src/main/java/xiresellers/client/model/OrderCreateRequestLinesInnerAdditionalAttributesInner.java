...
public class OrderCreateRequestLinesInnerAdditionalAttributesInner {
  ...
  public OrderCreateRequestLinesInnerAdditionalAttributesInner attributeName(@javax.annotation.Nullable String attributeName) {
  ...
  public OrderCreateRequestLinesInnerAdditionalAttributesInner attributeValue(@javax.annotation.Nullable String attributeValue) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderCreateRequestLinesInnerAdditionalAttributesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OrderCreateRequestLinesInnerAdditionalAttributesInner is not found in the empty JSON string", OrderCreateRequestLinesInnerAdditionalAttributesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderCreateRequestLinesInnerAdditionalAttributesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OrderCreateRequestLinesInnerAdditionalAttributesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
