...
public class OrderModifyResponseRejectedLineItemsInner {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ingramLineNumber", "customerLineNumber", "ingramPartNumber", "vendorPartNumber", "quantityOrdered", "rejectCode", "rejectReason"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderModifyResponseRejectedLineItemsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OrderModifyResponseRejectedLineItemsInner is not found in the empty JSON string", OrderModifyResponseRejectedLineItemsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderModifyResponseRejectedLineItemsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OrderModifyResponseRejectedLineItemsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("rejectCode") != null && !jsonObj.get("rejectCode").isJsonNull()) && !jsonObj.get("rejectCode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `rejectCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rejectCode").toString()));
      }
