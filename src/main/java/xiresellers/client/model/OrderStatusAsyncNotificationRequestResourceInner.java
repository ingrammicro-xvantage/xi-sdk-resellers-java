...
public class OrderStatusAsyncNotificationRequestResourceInner {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("eventType", "orderNumber", "customerOrderNumber", "orderEntryTimeStamp", "lines", "links"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderStatusAsyncNotificationRequestResourceInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OrderStatusAsyncNotificationRequestResourceInner is not found in the empty JSON string", OrderStatusAsyncNotificationRequestResourceInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderStatusAsyncNotificationRequestResourceInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OrderStatusAsyncNotificationRequestResourceInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("orderEntryTimeStamp") != null && !jsonObj.get("orderEntryTimeStamp").isJsonNull()) && !jsonObj.get("orderEntryTimeStamp").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `orderEntryTimeStamp` to be a primitive type in the JSON string but got `%s`", jsonObj.get("orderEntryTimeStamp").toString()));
      }
