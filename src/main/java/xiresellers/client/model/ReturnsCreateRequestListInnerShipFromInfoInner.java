  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReturnsCreateRequestListInnerShipFromInfoInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReturnsCreateRequestListInnerShipFromInfoInner is not found in the empty JSON string", ReturnsCreateRequestListInnerShipFromInfoInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReturnsCreateRequestListInnerShipFromInfoInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ReturnsCreateRequestListInnerShipFromInfoInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
