  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderDetailB2BLinesInnerEstimatedDatesInnerShip.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in OrderDetailB2BLinesInnerEstimatedDatesInnerShip is not found in the empty JSON string", OrderDetailB2BLinesInnerEstimatedDatesInnerShip.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderDetailB2BLinesInnerEstimatedDatesInnerShip.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OrderDetailB2BLinesInnerEstimatedDatesInnerShip` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("shipDateType") != null && !jsonObj.get("shipDateType").isJsonNull()) && !jsonObj.get("shipDateType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `shipDateType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("shipDateType").toString()));
      }
      ...
      if ((jsonObj.get("shipSource") != null && !jsonObj.get("shipSource").isJsonNull()) && !jsonObj.get("shipSource").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `shipSource` to be a primitive type in the JSON string but got `%s`", jsonObj.get("shipSource").toString()));
      }
      if ((jsonObj.get("shipDescription") != null && !jsonObj.get("shipDescription").isJsonNull()) && !jsonObj.get("shipDescription").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `shipDescription` to be a primitive type in the JSON string but got `%s`", jsonObj.get("shipDescription").toString()));
      }
