...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new xiresellers.client.model.FreightRequestShipToAddress.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new xiresellers.client.model.OrderCreateV7RequestVmfVendorAdditionalAttributesInner.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new xiresellers.client.model.OrderCreateV7RequestVmfVendorAdditionalAttributesInnerAdditionalAttributesInner.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new xiresellers.client.model.OrderCreateV7RequestVmfVendorAdditionalAttributesInnerAdditionalAttributesInnerChoicesInner.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new xiresellers.client.model.OrderCreateV7RequestVmfVendorAdditionalAttributesInnerAdditionalAttributesInnerChoicesInnerChoicesInner.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new xiresellers.client.model.VendorRequiredInfoRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new xiresellers.client.model.VendorRequiredInfoRequestProductsInner.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new xiresellers.client.model.VendorRequiredInforesponseInner.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new xiresellers.client.model.VendorRequiredInforesponseInnerResponseMessagesInner.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new xiresellers.client.model.VendorRequiredInforesponseInnerVmfAdditionalAttributesInner.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new xiresellers.client.model.VendorRequiredInforesponseInnerVmfAdditionalAttributesInnerAdditionalAttributesInner.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new xiresellers.client.model.VendorRequiredInforesponseInnerVmfAdditionalAttributesInnerAdditionalAttributesInnerChoicesInner.CustomTypeAdapterFactory());
