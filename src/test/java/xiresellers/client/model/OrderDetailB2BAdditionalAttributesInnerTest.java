...
/**
 * Model tests for OrderDetailB2BAdditionalAttributesInner
 */
public class OrderDetailB2BAdditionalAttributesInnerTest {
    private final OrderDetailB2BAdditionalAttributesInner model = new OrderDetailB2BAdditionalAttributesInner();
