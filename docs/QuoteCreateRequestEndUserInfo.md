...
|------------ | ------------- | ------------- | -------------|
|**companyName** | **String** | Name of the company associated with the quote. |  [optional] |
|**contact** | **String** | Contact name of end user associated with the quote. |  [optional] |
...
|**state** | **String** | Two letter state abbreviation for end user associated with the quote. |  [optional] |
|**postalCode** | **String** | Zip code of end user associated with the quote. |  [optional] |
|**countryCode** | **String** | Two letter Country abbreviation for end user associated with the quote. |  [optional] |
